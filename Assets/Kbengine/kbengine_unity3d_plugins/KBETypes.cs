...
namespace KBEngine
{
	...
	public struct BOOL
	{
		...
		public static implicit operator UInt16(BOOL value)
		{
			return value.value;
		}

		public static implicit operator BOOL(UInt16 value)
		{
			UInt16 tvalue = (UInt16)value;
	...
	public struct ENTITYID
	{
		...
		ENTITYID(UInt32 value)
		{
			this.value = value;
		}

		public static implicit operator UInt32(ENTITYID value)
		{
			return value.value;
		}
	...
	public class FRIEND_INFO_LIST : List<FRIEND_INFO>
	{

	}

	public class ENTITYCALL_LIST : List<byte[]>
	{
